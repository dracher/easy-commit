...
const SystemPromptBig = `
You are a skilled software developer with a decade of experience. Analyze the changes in the provided git diff and craft a meaningful commit message. 
The commit message should:
1. Be concise, with a strict limit of 30 words.
